...
Original file is located at
    https://colab.research.google.com/drive/1_ynqn6TDlgAem6ZMSV2ctiwUaq86I3NL
...
print("Hello", name + " " +surname +" as I know you are" , age +" years old.")
...
fahrenheit = float(input("Enter teperature in Fahrenheit: "))

celsius = (fahrenheit - 32)*5/9

print("Teperature in Celcius:", celsius)
